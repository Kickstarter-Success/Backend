exports.seed = function (knex, Promise) {
    return knex('kickstarter').insert([
        ...
        { user_id: 1, campaignName: 'Test_Project_4', monetaryGoal: 100000, description: 'Put the decription here and bla bla bla.', duration: '30', categories: 'Games', country: 'JAPAN' }
